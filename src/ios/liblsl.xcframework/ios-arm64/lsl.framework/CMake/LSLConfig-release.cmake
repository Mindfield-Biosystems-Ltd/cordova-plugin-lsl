...
set_target_properties(LSL::lsl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/Frameworks/lsl.framework/lsl"
  IMPORTED_SONAME_RELEASE "@rpath/lsl.framework/lsl"
  )

list(APPEND _cmake_import_check_targets LSL::lsl )
list(APPEND _cmake_import_check_files_for_LSL::lsl "${_IMPORT_PREFIX}/Frameworks/lsl.framework/lsl" )
